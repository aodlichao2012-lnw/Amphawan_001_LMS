...
{
    public partial class amphawan001 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dt_DATE_modify = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    int_id_num = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    st_keyword = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    int_order_by = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
